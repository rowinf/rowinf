...
There and back again was a stats.nz contest for visualizing workplace commuter data. I won honorable mention for my submission, where I was credited for the creativity of the parallel axis chart. I rendered the commuter data on MapBox with an accompanying parallel axis chart. [You can see the project here](https://rowinf.github.io/there-and-back-again/).
